...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='HumanoidDir-v0', help='environment to train on')
    ...
    parser.add_argument('--norm_state_for_policy', type=boolean_argument, default=False, help='normalise state input') # Leo: TODO - Check this out
