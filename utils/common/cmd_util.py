...
from utils.bench import Monitor
from utils.common import set_global_seeds
from utils.common.atari_wrappers import make_atari, wrap_deepmind
from utils.common.vec_env import SubprocVecEnv
from utils.common.vec_env import DummyVecEnv
from utils.common import retro_wrappers
...
def make_mujoco_env(env_id, seed, reward_scale=1.0):
    ...
    env.seed(seed)
    if reward_scale != 1.0:
        from utils.common.retro_wrappers import RewardScaler
